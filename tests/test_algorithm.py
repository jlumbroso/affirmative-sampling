...
def test_call_affirmative_sampling_one_token_k_to_size():
    affirmative_sampling.algorithm.affirmativeSampling(tokens=_ONE_TOKEN, k=len(_ONE_TOKEN))

def test_call_affirmative_sampling_several_unique_token_k_to_size():
    affirmative_sampling.algorithm.affirmativeSampling(tokens=_SEVERAL_TOKENS, k=len(_SEVERAL_TOKENS))

def test_call_affirmative_sampling_several_unique_token_k_smaller():
    affirmative_sampling.algorithm.affirmativeSampling(
